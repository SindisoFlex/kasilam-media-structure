...
const WeddingProduction = () => {
  ...
  const mediaTypes = [
    ...
    },
    {
      ...
      icon: "🎥",
      desc: "Cinematic video coverage",
    },
    {
      id: "combo",
      label: "Photo + Video Combo",
      icon: "✨",
      desc: "Complete visual storytelling (Recommended)",
      recommended: true,
    },
  ];
  ...
  const whyChooseUs = [
    {
      ...
      desc: "We capture genuine emotions and unscripted moments that tell your unique story",
    },
    {
      title: "Professional Equipment",
      desc: "State-of-the-art cameras and lighting ensure stunning results in any lighting condition",
    },
    {
      title: "Experienced Team",
      desc: "Years of wedding experience means we anticipate and capture the moments that matter",
    },
    {
      title: "Timeless Quality",
      desc: "Professional editing and color grading create memories you'll treasure for generations",
    },
  ];
      ...
      <section className="section-padding bg-zinc-950">
        <div className="content-width">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-white/70 leading-relaxed mb-8 font-medium">
              Our goal is to capture authentic moments that allow you to relive your wedding day for years to come. From the nervous anticipation before the ceremony to the joy on the dance floor, every moment gets the attention it deserves.
            </p>
            <p className="text-lg text-white/60 leading-relaxed font-medium">
              When you look back at your wedding memories, you won't just remember the day—you'll feel the emotions all over again. That's what we deliver: memories that last a lifetime.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="content-width">
          <div className="mb-16 text-center">
            ...
            <p className="text-lg text-white/60 font-medium">
              Choose the perfect coverage time for your celebration. All packages include edited final media delivered on USB.
            </p>
          </div>
