...
const pricingTiers = [
  {
    name: "Single Track",
    price: "R____",
    features: ["Beat sourcing", "1 producer connection", "Basic coordination"],
    highlighted: false,
  },
  {
    name: "EP Package",
    price: "R____",
    features: ["Up to 5 tracks", "Multiple producer sourcing", "Full coordination", "Project management"],
    highlighted: true,
  },
  {
    name: "Album Production",
    price: "R____",
    features: ["Up to 12 tracks", "Full beat sourcing", "Producer negotiations", "Complete workflow management", "Priority support"],
    highlighted: false,
  },
];
  ...
  return (
    <div>
      ...
      <section className="bg-card py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-center text-3xl font-bold md:text-4xl">
            Production Management <span className="text-primary">Packages</span>
          </h2>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold md:text-4xl">
            Start Your Music <span className="text-primary">Production Project</span>
          </h2>
