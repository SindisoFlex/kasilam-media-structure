        ...
        <div className="min-h-screen bg-background">
            <section className="relative py-24 md:py-32 overflow-hidden">
                ...
                <div className="container relative mx-auto px-4 text-center">
                    ...
                    <HeroSection delay={0.3}>
                        <Button
                            onClick={() => openBooking({
                                service: "Music Production Management",
                                package: "Production Inquiry",
                                price: 0
                            })}
                            size="lg"
            ...
            <section className="py-20 bg-card/50">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <FadeInSection delay={0.1} className="max-w-2xl mx-auto p-8 rounded-3xl border border-primary bg-primary/5 shadow-xl">
                        ...
                        <StaggerContainer>
                            <ul className="text-left space-y-4 mb-8">
                                {["Finding the right producer for your style", "Negotiating beat licenses and agreements", "Managing artist-producer collaboration", "Project workflow and timeline management", "Final beat delivery and file organization"].map(f => (
                                    <StaggerItem key={f}>
