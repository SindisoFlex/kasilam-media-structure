...
const WeddingWhitePage = () => {
  useEffect(() => {
    document.title = "White Wedding Gallery | Kasilam Media Productions";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Explore our white wedding photography gallery. Timeless and elegant coverage for your special day.");
    }
  }, []);
        ...
        <div className="content-width flex items-center justify-between py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="text-xl font-black">White Wedding</h1>
            </div>
          </div>
      ...
      <section className="section-padding pt-12">
        <div className="content-width">
          <motion.div 
            ...
            className="mb-12"
          >
            <p className="text-sm text-white/50 font-medium mb-4">Elegant and timeless coverage of contemporary white wedding ceremonies.</p>
            <h2 className="text-3xl md:text-5xl font-black text-gradient">White Weddings.</h2>
          </motion.div>
          ...
          <div className="mt-20 text-center py-20 rounded-[3rem] border border-dashed border-white/10 bg-white/[0.01]">
            ...
            <p className="text-white/40 max-w-lg mx-auto leading-relaxed">
              We are currently curating our finest white wedding coverage. Check back soon for the full high-resolution gallery.
            </p>
          </div>
        </div>
      </section>
...
export default WeddingWhitePage;
