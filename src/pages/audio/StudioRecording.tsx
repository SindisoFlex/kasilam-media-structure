            ...
            <section className="py-20 bg-card/50">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <StaggerContainer className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        {[
                            { name: "Starter Recording", price: "R350 / hour", desc: "Perfect for artists who already have their song ready.", features: ["Studio recording session", "Professional mic setup", "Basic vocal guidance", "Raw audio files"] },
                            { name: "Professional Recording", price: "R900", desc: "3-hour session. Best for singles and demos.", highlighted: true, features: ["3 hours studio recording", "Vocal direction", "Basic editing and cleanup", "Rough mix preview"] },
                            { name: "Full Song Production", price: "R2500 per song", desc: "Perfect for artists releasing music.", features: ["Full vocal recording", "Vocal editing & tuning", "Mixing", "Mastering", "Final ready-to-release track"] }
                        ].map((tier, i) => (
