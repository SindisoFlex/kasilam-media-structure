      ...
      return (
        <div className="min-h-screen bg-black flex items-center justify-center p-6 text-center">
          <div className="max-w-md">
            ...
            <p className="text-white/50 mb-8">We're having trouble loading this page. Please try refreshing or come back later.</p>
            <Button onClick={() => window.location.reload()} className="btn-primary rounded-full px-8 h-12 uppercase tracking-widest text-[10px] font-black">
              Refresh Page
            </Button>
          </div>
        </div>
