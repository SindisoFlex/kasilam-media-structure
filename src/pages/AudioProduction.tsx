...
const AudioProduction = () => {
  ...
  const handleBookGeneric = () => {
    openBooking({
      ...
      packageName: "Recording Session",
      mediaType: "none",
      basePrice: 0,
      eventType: "Audio Production",
    });
  };
  ...
  return (
    <div>
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <HeroSection delay={0.3}>
              <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                <Button onClick={handleBookGeneric} size="lg" className="gap-2">
        ...
        <div className="container mx-auto px-4">
          <FadeInSection className="mx-auto max-w-4xl text-center">
            ...
            <div className="space-y-6 text-lg leading-relaxed text-muted-foreground">
              <p>At Kasilam Media Production, we help artists, businesses, and content creators produce high-quality audio projects from start to finish.</p>
              <p>Whether you're recording a song, launching a podcast, or producing a voice-over, we coordinate the right recording environment, technical expertise, and creative collaboration to deliver a professional result.</p>
              <p>Instead of limiting you to one production style, we work with a network of trusted sound engineers, producers, and creatives to bring your project to life.</p>
            </div>
          </FadeInSection>
        </div>
      </section>
      ...
      <section className="bg-card py-20">
        <div className="container mx-auto px-4">
          <FadeInSection>
            <h2 className="text-center text-3xl font-bold md:text-4xl">How It <span className="text-primary">Works</span></h2>
          </FadeInSection>
          <StaggerContainer className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { icon: MessageSquare, title: "Consultation & Project Planning", desc: "We start by understanding your project goals, creative direction, and technical requirements." },
              { icon: Mic, title: "Recording Session", desc: "Your audio is captured in a focused recording environment using professional equipment." },
              { icon: Sliders, title: "Production & Collaboration", desc: "We coordinate with experienced sound engineers and producers to refine and enhance your audio." },
              { icon: CheckCircle, title: "Final Mix & Delivery", desc: "You receive clean, balanced, professional audio files ready for release or distribution." },
            ].map((step, i) => (
      ...
      <section id="services" className="py-20">
        <div className="container mx-auto px-4">
          <FadeInSection>
            <h2 className="text-center text-3xl font-bold md:text-4xl">Services <span className="text-primary">Included</span></h2>
          </FadeInSection>
      ...
      <section className="bg-muted/30 py-20 border-y border-border">
        <div className="container mx-auto px-4">
          <FadeInSection>
            <h2 className="text-center text-3xl font-bold md:text-4xl mb-12">Extra <span className="text-primary">Services</span></h2>
          </FadeInSection>
      ...
      <section id="packages" className="py-20">
        <div className="container mx-auto px-4">
          <FadeInSection>
            <h2 className="text-center text-3xl font-bold md:text-4xl">Production <span className="text-primary">Packages</span></h2>
          </FadeInSection>
          <StaggerContainer className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {[
              { name: "Starter Recording", price: 350, priceLabel: "R350 / hour", features: ["Studio recording session", "Professional mic setup", "Basic vocal guidance", "Raw audio files"], highlighted: false },
              { name: "Professional Package", price: 900, priceLabel: "R900", features: ["3-hour recording session", "Vocal direction", "Basic editing & cleanup", "Rough mix preview"], highlighted: true },
              { name: "Full Song Production", price: 2500, priceLabel: "R2500 / song", features: ["Full vocal recording", "Vocal editing & tuning", "Professional Mixing", "Mastering Coordination", "Ready-to-release track"], highlighted: false },
              { name: "Artist Development", price: 5000, priceLabel: "R5000 - R8000", features: ["3 songs (Recording+Mix+Master)", "Creative production direction", "Cover art guidance", "Distribution guidance", "Priority scheduling"], highlighted: false },
            ].map((tier) => (
              <StaggerScaleItem key={tier.name}>
                <Card className={`flex flex-col h-full shadow-lg ${tier.highlighted ? "border-2 border-primary" : "border-primary/20"}`}>
        ...
        <div className="container mx-auto px-4 text-center">
          <FadeInSection>
            <h2 className="text-3xl font-bold md:text-4xl">
              Ready to Create Professional <span className="text-primary">Audio?</span>
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
              Book your session and let us manage the recording and production process from start to finish.
            </p>
            <Button onClick={handleBookGeneric} size="lg" className="mt-8 gap-2">
