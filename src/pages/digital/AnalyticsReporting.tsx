...
const AnalyticsReporting = () => {
    const problems = [
        "Not knowing which marketing channels are working",
        "Flooded with data but lacking clear insights",
        "Difficulty measuring the true ROI of digital spend",
        "No clear tracking of customer journeys and conversions",
    ];
    ...
    const pricing = [
        ...
        },
        {
            ...
            price: "R2,500",
            period: "/ month",
            features: ["Advanced event tracking", "Custom ROI dashboards", "Monthly strategy deep-dive", "Competitor tracking"],
            highlighted: true,
        },
        {
            ...
            price: "R5,000+",
            period: "/ month",
            features: ["Full funnel analysis", "Multi-channel attribution", "Custom data integrations", "Weekly reporting & calls"],
            highlighted: false,
        },
    ];

    const targetAudience = [
        "Businesses scaling their ad spend",
        "Data-driven marketers needing clarity",
        "E-commerce owners tracking CAC & LTV",
        "Local companies wanting to see what works",
        "B2B firms measuring lead quality",
    ];
                ...
                <div className="container relative mx-auto px-4">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <p className="mt-6 text-lg text-muted-foreground">
                            Stop guessing and start knowing. We provide clear, actionable data insights that show you exactly where your growth is coming from.
                        </p>
            ...
            <section className="bg-muted py-20">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
                        Most businesses have plenty of data, but very little clarity on what it actually means.
                    </p>
                    ...
                    <p className="mt-10 text-lg font-medium text-primary uppercase tracking-wider">
                        We help you cut through the noise and focus on the metrics that matter.
                    </p>
                </div>
            </section>
            ...
            <section className="py-20 bg-background text-center">
                <div className="container mx-auto px-4">
                    ...
                    <p className="mx-auto mb-10 max-w-2xl text-lg text-muted-foreground">
                        Let's set up the tracking and insights you need to scale your business with confidence.
                    </p>
                    <Button asChild size="lg" className="px-10 h-14 text-lg">
                        <Link to="/booking">Book a Data Audit</Link>
                    </Button>
                </div>
            </section>
        </div>
