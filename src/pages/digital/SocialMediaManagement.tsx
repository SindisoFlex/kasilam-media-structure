                ...
                <div className="container relative mx-auto px-4">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <p className="mt-6 text-lg text-muted-foreground">
                            We help businesses build a strong and consistent social media presence through strategy, content creation, and audience engagement. Our goal is to turn your social media platforms into powerful tools for brand awareness and customer growth.
                        </p>
                ...
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="mx-auto mt-8 max-w-3xl rounded-2xl bg-background p-8 border border-border">
                        ...
                        <p className="text-lg text-muted-foreground leading-relaxed">
                            Many businesses struggle with inconsistent posting, low engagement, and unclear content strategy. Our team helps you create a professional and consistent social media presence that attracts the right audience.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-muted py-20">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid gap-8 md:grid-cols-3">
                        {pricing.map((tier, i) => (
                            <Card key={i} className={`relative flex flex-col items-center p-8 text-center bg-background ${tier.highlighted ? "border-primary border-2" : "border-border"}`}>
                                {tier.highlighted && (
            ...
            <section className="py-20 bg-background text-center">
                <div className="container mx-auto px-4">
                    ...
                    <p className="mx-auto mb-10 max-w-2xl text-lg text-muted-foreground">
                        Let's turn your social media into a powerful growth tool for your brand.
                    </p>
